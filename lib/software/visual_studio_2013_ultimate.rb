...
class VisualStudio2013Ultimate < Software
  ...
  def import_settings(settings_file)
    @shell.run "'#{@visual_studio_exe}' /Command 'Tools.ImportandExportSettings /import:\"#{configatron.devtools}/settings/windows/visual-studio-2013/#{settings_file}\"'", platform
  end
end