...
class VisualStudio2012Ultimate < Software
  ...
  def import_settings(settings_file)
    @shell.run "'#{@visual_studio_exe}' /Command 'Tools.ImportandExportSettings /import:\"#{configatron.devtools}/settings/windows/visual-studio-2012/#{settings_file}\"'", platform
  end
end